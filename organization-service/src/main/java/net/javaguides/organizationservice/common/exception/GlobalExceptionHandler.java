package net.javaguides.organizationservice.common.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CommonResponse> handleMissingRequestValueException(MissingRequestValueException e) {
        ...
        final String code = ErrorCode.MISSING_REQUEST_VALUE.getCode();
        final String message = ErrorCode.MISSING_REQUEST_VALUE.getMessage();
...
//    }
    ...
    public ResponseEntity<CommonResponse> httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        CommonResponse response = CommonResponse.failOf(ErrorCode.NOT_SUPPORT_METHOD.getMessage(), ErrorCode.NOT_SUPPORT_METHOD.getCode());
        return ResponseEntity
